...
public class BikeWeapon : MonoBehaviour
{
    ...
    private void OnGUI()
    {
        ...
        if (mainAttachment != null && _isDecorated)
            GUI.Label(new Rect(5, 150, 300, 100), "Main Attachment: " + mainAttachment.name);

        if (secondaryAttachment != null && _isDecorated)
            GUI.Label(new Rect(5, 170, 300, 100), "Secondary Attachment: " + secondaryAttachment.name);
    }
